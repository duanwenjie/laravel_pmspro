...
use App\Exports\Mrp\MrpReportOrdersModAftV3Export;
...
class MrpReportOrdersModAftV3Service
{
    ...
    public function export()
    {
        ...
        $fileName = date('YmdHis').'_'."SKU销量统计（修正后）.csv";
        Excel::store(new MrpReportOrdersModAftV3Export($builder), $fileName, 'export', \Maatwebsite\Excel\Excel::CSV);
    ...
    {
        $request = request();
        return MrpReportOrdersModAftV3::query()->filter(
            $request->input('data', []),
